...
<div class="not-prose my-12 overflow-hidden rounded-3xl border border-slate-700 shadow-2xl bg-slate-900">
    <div id='viz1772030117244' style='position: relative; width: 100%;'>
        <noscript>
            <a href='#'>
                <img alt='Monthly Gold Prices' src='https://public.tableau.com/static/images/Mo/MonthlyGoldPricesoverthelast20years/GoldPrices_1/1_rss.png' style='border: none' />
            </a>
        </noscript>
        <object class='tableauViz' style='display:none;'>
            ...
            <param name='name' value='MonthlyGoldPricesoverthelast20years/GoldPrices_1' />
            <param name='tabs' value='no' />
            <param name='toolbar' value='yes' />
            <param name='static_image' value='https://public.tableau.com/static/images/Mo/MonthlyGoldPricesoverthelast20years/GoldPrices_1/1.png' /> 
...
<script type='text/javascript'>
    var divElement = document.getElementById('viz1772030117244');
    var vizElement = divElement.getElementsByTagName('object')[0];
    
    // This makes the dashboard fill the width and stay a reasonable height
